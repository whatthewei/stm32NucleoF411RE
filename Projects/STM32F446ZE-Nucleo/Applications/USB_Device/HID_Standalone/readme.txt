...
use USB device application based on the Human Interface (HID) on the STM32F446xx devices.
...
@par Hardware and Software environment
  ...
  - NUCLEO-F446ZE Set-up
    - Connect the NUCLEO-F446ZE board to the PC through 'USB micro A-Male 
