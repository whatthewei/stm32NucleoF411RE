...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F429xx devices.

This is a typical application on how to use the STM32F429ZI USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32F429ZI devices.
...
In this application, two operating modes are available:
 ...
 2. Run-time application mode: 
    This is the normal run-time activities. A binary which toggles LEDs on the nucleo board is 
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32429ZI_GPIOIOToggle_0x8008000 .dfu" provided in Binary
     directory.
