...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F446xx devices.

This is a typical application on how to use the STM32F446xx USB OTG Device peripheral to implement the DFU
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32446E_EVAL_SysTick_0x08008000.dfu" provided in Binary
     directory.
