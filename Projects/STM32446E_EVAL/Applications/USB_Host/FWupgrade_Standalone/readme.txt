...
USB host application based on the In-Application programming (IAP) on the STM32F446xx devices.

This is a typical application on how to use the STM32F446xx USB OTG Host peripheral for firmware upgrade 
...
@par Directory contents 
  ...
  - USB_Host/FWupgrade_Standalone/Binary/
    ...
    - STM32446E_EVAL_SysTick_0x08008000.bin
