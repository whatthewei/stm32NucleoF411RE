...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect, "  00000000 Pixels/s ", ID_BENCH_CPU,    85, 125, 300, 25,  0, 0, 0 }, 
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = TEXT_CreateEx(10, 30, 100, 25, pMsg->hWin, WM_CF_SHOW,0, 0x123,"");
    ...
    hGraph = GRAPH_CreateEx(10, 45, 300, 95, pMsg->hWin, WM_CF_SHOW, 0, GUI_ID_GRAPH0);
