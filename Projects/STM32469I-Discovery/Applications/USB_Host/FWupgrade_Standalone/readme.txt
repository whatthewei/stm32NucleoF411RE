...
USB host application based on the In-Application programming (IAP) on the STM32F469xx devices.

This is a typical application on how to use the STM32F469xx USB OTG Host peripheral for firmware upgrade 
...
@par Directory contents 
  ...
  - USB_Host/FWupgrade_Standalone/Binary/
    ...
    - "STM32469I_DISCOVERY_SysTick_0x08008000.bin 
