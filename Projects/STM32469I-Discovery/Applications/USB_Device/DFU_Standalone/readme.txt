...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F469xx devices.

This is a typical application on how to use the STM32F469xx USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32F469xx devices.
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32469I_DISCOVERY_SysTick_0x08008000.dfu" provided in Binary
     directory.
