...
static const GUI_WIDGET_CREATE_INFO _aFileErrorDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Video player", ID_FRAMEWIN_0, 0, 0, 600, 350, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Cannot play video while the VNC ", ID_TEXT_FILENAME, 90, 130, 430, 30, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Server is running", ID_TEXT_FILENAME + 2, 185, 170, 300, 30, 0, 0x0, 0 },  
  { BUTTON_CreateIndirect, "OK", ID_BUTTON_OK_MESSAGE, 230, 240, 120, 120, 0, 0x0, 0  },
};
