...
User has to use a PC SW tool (ex. TFTPD32 or TFTPD64) to send/receive data to/from 
micro SD card installed in STM32469I-EVAL board. In order to do that, go to
"Tftp Client" page, Host = 192.168.0.10, Port = 69, select files names with max 8+3 
characters (e.g. file5678.txt) and press Put and Get.
...
@par Hardware and Software environment
  ...
  - STM32469I-EVAL Set-up
    ...
    - Insert a uSD Card to the MSD connector (CN17).
