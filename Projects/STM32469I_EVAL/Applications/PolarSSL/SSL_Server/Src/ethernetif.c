...
/* Ethernet pins configuration ************************************************/
  ...
  */
  ...
  (which MII_CRS is not connected to PA0 of STM32F479I) because PA0 is shared
  with MC_ENA.
  If Half duplex mode is needed, uncomment PA0 configuration code source (above 
  the note) and close the SB48 solder bridge of the STM32479I-EVAL board .
  */
  ...
  Note: Ethernet Full duplex mode works properly in the default setting
  (which MII_COL is not connected to PH3 of STM32F479I) because PH3 is shared
  with SDRAM chip select SDNE0. 
  If Half duplex mode is needed, uncomment PH3 configuration code source (above 
  the note)  then remove R243 and close SB63 solder bridge of the STM32479I-EVAL board.
  */
  ...
  connected to PI10 of STM32F479I) because PI10 is shared with data signal 
  of SDRAM. 
  If RX_ER signal is needed, uncomment PI10 configuration code source (above 
  the note) then remove R244 and solder SB12 of the STM32479I-EVAL board.
  */
