...
the HTTP server (STM32479I-EVAL) contains a html page dynamically refreshed 
(every 1 s), it shows the RTOS statistics in runtime (https://192.168.0.10/)
...
STM32479I-EVAL board, for more information refer to the HAL_ETH_MspInit() 
...
@par Hardware and Software environment  
  ...
  - This application runs on STM32F479xx devices.
  ...
  - STM32479I-EVAL Set-up 
    - Connect STM32479I-EVAL board to remote PC (through a crossover ethernet cable)
      or to your local network (through a straight ethernet cable)
    - RS232 link (used with HyperTerminal like application to display debug messages):
      connect a null-modem female/female RS232 cable between the DB9-male connector 
