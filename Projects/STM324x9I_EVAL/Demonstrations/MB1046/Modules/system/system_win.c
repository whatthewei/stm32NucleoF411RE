...
#define ID_BUTTON_APPLYSETTINGS  (GUI_ID_USER + 0x29)
...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { FRAMEWIN_CreateIndirect, "System", ID_FRAMEWIN_INFO, 0, 0, 480, 246, 0, 0x64, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_INFO, 362, 24, 90, 90, 0, 0, 0 },
  { BUTTON_CreateIndirect, "Exit", ID_BUTTON_INFO_CLOSE, 363, 127, 90, 90, 0, 0x0, 0 },
  { MULTIPAGE_CreateIndirect, "Multipage", ID_MULTIPAGE, 22, 15, 329, 202, 0, 0x0, 0 },  
};

static const GUI_WIDGET_CREATE_INFO _aDialogSystemInformation[] = {
  { WINDOW_CreateIndirect, "System Information", 0, 0,   0, 329, 202, FRAMEWIN_CF_MOVEABLE },
  { TEXT_CreateIndirect, "Board : STM324x9I", ID_TEXT_BOARD, 40, 24, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Core: STM32F429", ID_TEXT_CORE, 40, 44, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "CPU Speed : up to 180MHz", ID_TEXT_CPU, 40, 64, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Firmware Version : 1.0", ID_TEXT_VERSION, 40, 84, 280, 20, 0, 0x0, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_LOGO, 140, 110, 40, 20, 0, 0, 0 },  
  { TEXT_CreateIndirect, "Copyright (c) STMicroelectronics 2015", ID_TEXT_COPYRIGHT, 40, 142, 280, 20, 0, 0x0, 0 },  
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogClockSettings[] = {
  { WINDOW_CreateIndirect, "Clock Settings", 0, 0,   0, 329, 202, FRAMEWIN_CF_MOVEABLE },
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_HOUR, 196, 103, 37, 30, 0, 0x0, 0 },  
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_MINUTE, 236, 103, 36, 30, 0, 0x0, 0 },
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_SEC, 275, 103, 37, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Apply settings", ID_BUTTON_APPLYSETTINGS, 195, 140, 116, 37, 0, 0x0, 0 },
};
...
static void _cbClockSettings(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    {
      k_GetTime(&Time);   
      GUI_UpdateClock (255, 50, Time.Hours, Time.Minutes, Time.Seconds);
