...
static const GUI_WIDGET_CREATE_INFO _aProcessManagerDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Process viewer", ID_FRAMEWIN_PROCESSMANAGER, 100, 100, 405, 240, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Cancel", ID_BUTTON_CANCEL_PROCESSMANAGER, 166, 200, 80, 30, 0, 0x0, 0 },
  { LISTVIEW_CreateIndirect, "Listview", ID_LISTVIEW_PROCESSMANAGER, 6, 9, 380, 190, 0, 0x0, 0 },
};
...
static void _OnPaint(BUTTON_Handle hObj) {
  ...
  GUI_DrawBitmap(&bmSTLogo50x40, 0, 0);
}
...
void k_InitMenu(void) 
{
  ...
  hItem = BUTTON_CreateEx(0, 0, 50, 43, WM_HBKWIN, WM_CF_SHOW, 0, ID_BUTTON_BKGND);
