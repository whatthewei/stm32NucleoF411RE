...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect,    "Audio Player", ID_FRAMEWIN_INFO,     0,   0,   640, 439, 0, 0x64, 0 },
  { LISTVIEW_CreateIndirect,  "Listview",     ID_WAVFILE_LIST,      280, 06,  350, 425, 0, 0x0,  0 },  
  { SLIDER_CreateIndirect,    "Slider",       ID_VOLUME_SLIDER,     145, 155, 125, 20,  0, 0x0,  0 },
  { SLIDER_CreateIndirect,    "Slider1",      ID_DURATION_SLIDER,   15,  125,  255, 20,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "Title",        ID_TITLE_CAPTION,     20,  10,  40,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "",             ID_TITLE,             60,  10,  150, 30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "Duration",     ID_ELAPSED_TIME,      35,  217, 250, 250,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "AUTHOR",       ID_AUTHOR_CAPTION,    20,  30,  60,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "AUTHOR",       ID_AUTHOR,            80,  30,  70,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "samplingRate", ID_SAMPLING_CAPTION,  20,  50,  80,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "Value",        ID_SAMPLING_VALUE,    100,  50,  70,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "Time",         ID_TOTAL_TIME,        20,  70,  50,  30,  0, 0x0,  0 },
};
...
static void AudioDirectOpen(char *filename)
{
  ...
  AUDIOPLAYER_Init();  
  AUDIOPLAYER_hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_GetDesktopWindowEx(1), 0, 41);
