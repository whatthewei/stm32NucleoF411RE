...
static const GUI_POINT aPoints[3][4] = {
  ...
  {{ 0 * AA_FACTOR, 2 * AA_FACTOR},
   ...
   { 0 * AA_FACTOR,-12 * AA_FACTOR},
   { 1 * AA_FACTOR,-4 * AA_FACTOR}},

  /* Min Needle */
  {{ 0 * AA_FACTOR, 2 * AA_FACTOR},
   {-1 * AA_FACTOR,-2 * AA_FACTOR},
   { 0 * AA_FACTOR,-16 * AA_FACTOR},
   { 1 * AA_FACTOR,-2 * AA_FACTOR}},
   /* Sec Needle */
  {{0 * AA_FACTOR, 1 * AA_FACTOR},
   { 1 * AA_FACTOR, 1 * AA_FACTOR},
   { 1 * AA_FACTOR,-60 * AA_FACTOR},
   {0 * AA_FACTOR,-60 * AA_FACTOR}},
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogSystemInformation[] = {
  { WINDOW_CreateIndirect, "System Information", 0, 0,   0, 600, 342, FRAMEWIN_CF_MOVEABLE },
  { TEXT_CreateIndirect, "Board : STM324x9I", ID_TEXT_BOARD, 160, 24, 300, 50, 0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogGeneralSettings[] = {
  { WINDOW_CreateIndirect, "General Settings", 0, 0, 0, 600, 342, FRAMEWIN_CF_MOVEABLE },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_SPRITES, 26, 30, 160, 25, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_BACKGROUND, 26, 75, 227, 25, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_CPU180, 26, 115, 215, 25, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_FLEXSKIN, 26, 155, 180, 25, 0, 0x0, 0 },
