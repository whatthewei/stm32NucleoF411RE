...
{
  { FRAMEWIN_CreateIndirect, "USB Mass Storage Device [mSD]",   ID_FRAMEWIN_INFO,        0,   0,   640, 439, 0, 0x64, 0 },
  { IMAGE_CreateIndirect,    "Image",        ID_USB_NOT_CONNECTED,    170,  59,  100, 100, 0, 0,   0 },
  { IMAGE_CreateIndirect,    "Image",        ID_MSD_NOT_CONNECTED,    365,  59,  100, 100, 0, 0,   0 },
  { BUTTON_CreateIndirect,   "Connect USB ", ID_BUTTON_USB,           145,  260, 350,  55,  0, 0,  0 },
  { IMAGE_CreateIndirect,    "",             ID_IMAGE1_CONNECTED,      226, 120,  18,  19,  0, 0,    0 },
  { IMAGE_CreateIndirect,    "",             ID_IMAGE2_CONNECTED,      421, 120,  18,  19,  0, 0,    0 },
