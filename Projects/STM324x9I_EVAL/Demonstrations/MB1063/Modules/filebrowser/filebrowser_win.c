...
{
  { FRAMEWIN_CreateIndirect, "File Browser", ID_FRAMEWIN, 0, 0, 640, 439, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, "Refresh", ID_BUTTON_REFRESH, 525, 355, 95, 35, 0, 0x0, 0 },
  { TREEVIEW_CreateIndirect, "Treeview", ID_TREEVIEW, 7, 6, 495, 385, 0, 0x0, 0 }, 
  { PROGBAR_CreateIndirect, "Progbar", ID_PROGBAR_MSD, 525, 68, 95, 20, 0, 0x0, 0 },
  { PROGBAR_CreateIndirect, "Progbar", ID_PROGBAR_USB, 525, 28, 95, 20, 0, 0x0, 0 }, 
  { TEXT_CreateIndirect, "microSD", ID_TEXT_MSD, 525, 15, 100, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "USB Disk", ID_TEXT_USB, 526, 56, 100, 20, 0, 0x0, 0 }, 
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_0, 520, 160, 100, 100, 0, 0, 0 },  

};

/* Dialog Create */
static const GUI_WIDGET_CREATE_INFO _aFileInfoDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "File Information", ID_FRAMEWIN_0, 0, 0, 320, 160, 0, 0x0, 0 },
  ...
  { BUTTON_CreateIndirect, "OK", ID_BUTTON_OK_FILEINFO, 110, 90, 80, 26, 0, 0x0, 0 },
};
...
static void _RefreshBrowser ( WM_HWIN hWin) {
  ...
  /* Show Hint */
  Hint = WM_CreateWindowAsChild(192,
                                190,
                                200, 32,
                                hWin,
                                WM_CF_SHOW , 
