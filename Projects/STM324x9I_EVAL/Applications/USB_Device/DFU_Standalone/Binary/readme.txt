...
This file was converted to the DFU format using the "DFU File Manager Tool" included in the "DfuSe" PC
software install.
...
This binary is a simple LED chaser. The 4 LEDs lights one by one for a period of 200 ms and the cycle 
